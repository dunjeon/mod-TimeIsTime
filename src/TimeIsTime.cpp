...
public:
    ...
    void OnBeforeConfigLoad(bool /*reload*/) override {
        ...
        stimeistime_speed_rate = sConfigMgr->GetOption<bool>("TimeIsTime.SpeedRate", 1.0);
        stimeistime_hour_offset = sConfigMgr->GetOption<bool>("TimeIsTime.HourOffset", 0.0);
        stimeistime_time_start = sConfigMgr->GetOption<bool>("TimeIsTime.TimeStart", 0);
    }
};
